...
outtextxy(10,550,"                                                                             ");
  ...
  readimagefile("background.bmp",0,0,1000,600);
    outtextxy(98,100,"Press 1 to edit movie");
     settextstyle(1,HORIZ_DIR,4);
   b=getch();
   if(b=='1')
   edit(ma,index[a-1-48]);
...
//producer
    ...
    if(choice=='y')
    {
        ...
        cin>>opening_weekend;
        ma[index]->b.setopening_weekend(opening_weekend);
    }
    ...
    if(choice=='y')
    {
        cout<<"weekend_gross= ";
        cin>>weekend_gross;
        ma[index]->b.setweekend_gross(weekend_gross);
    }
    //countrygross
    ...
    if(choice=='y')
    {
        ...
        cout<<"country_gross= ";
        cin>>country_gross;
        ma[index]->b.setcountry_gross(country_gross);
    }
...
outtextxy(10,130,"Enter 2 to search a movie to edit ");
outtextxy(10,160,"Enter 3 to add movies to database");
outtextxy(10,190,"Enter 4 to view movies according to gross");
outtextxy(10,220,"Enter 5 to view movies according to budget");
outtextxy(10,250,"Enter 6 to view movies according to rating range");
outtextxy(10,280,"Enter 7 to view movies according to date of release");
